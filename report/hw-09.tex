...
\begin{center}
  \begin{tikzpicture}[
    ...
    \begin{axis}[
      ...
      \addplot[mark=none,const plot,solid] table {../phi-180.txt};
      \addplot[mark=none,const plot,dotted] table {../source-180.txt};
...
is \(k = 0.93582\) and the dominance ratio is \(\sigma = 
0.99650\). This time, the solution took 1790 iterations to 
...
\begin{center}
  \begin{tikzpicture}[
    ...
    \begin{axis}[
      ...
      \addplot[mark=none,const plot,solid] table {../phi-360.txt};
      \addplot[mark=none,const plot,dotted] table {../source-360.txt};
...
\begin{center}
  \begin{tabular}{c S[table-format=4.0]}
    \toprule
    \textbf{Skipped Iterations} & \textbf{Convergence Time} \\ \midrule
    2 & 1558 \\
    \(\infty\) (no shift) & 1790 \\ \bottomrule
  \end{tabular}
\end{center}
